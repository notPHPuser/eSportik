...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="cssfiles/underArmour.css" />
    <script src="jsFiles/undre.js" defer></script>
  </head>
  <body>
    <div class="line">
    ...
    <div class="first">
      <button class="forMen" id="forMen">
        <img src="undrePNG/forMen.png" class="photoForMen" />
      </button>
      <p class="tForMen">ДЛЯ МУЖЧИН</p>
      <button class="forWomen" id="forWomen">
        <img src="undrePNG/forWomen.png" class="photoForWomen" />
      </button>
      <p class="tForWomen">ДЛЯ ЖЕНЩИН</p>
      <button class="forChildren" id="forChildren">
        <img src="undrePNG/forChildren.png" class="photoForChildren" />
      </button>
      <p class="tForChildren">ДЛЯ ДЕТЕЙ</p>
    </div>
    <div class="second">
      <button class="odejda" id="odejda">
        <img src="undrePNG/odejdaaaa.png" class="photoOdejda" />
      </button>
      <p class="tOdejda">Одежда</p>
      <button class="obyv" id="obyv">
        <img src="undrePNG/obyv.png" class="photoObyv" />
      </button>
      <p class="tObyv">Обувь</p>
      <button class="aks" id="aks">
        <img src="undrePNG/aks.png" class="photoAks" />
      </button>
      <p class="tAks">Аксессуары</p>
    </div>
    <div class="niz"></div>
