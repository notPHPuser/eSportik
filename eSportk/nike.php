...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="cssfiles/nikee.css" />
    <script src="jsFiles/nike.js" defer></script>
  </head>
  <body>
    <div class="line">
    ...
    <div class="yce">
      ...
      <button id="shtanni" class="shtani">
    ...
    <button id="adidass" class="nike">
      <img src="png/nike.png" class="nikee" />
    </button>
    <img src="adikPNG/mot.png" class="mot" />
    <div class="first">
      <button class="forMenNike" id="formenNike">
        <img src="nikePNG/oneto.png" class="photoForMenNike" />
      </button>
      <p class="tForMenNike">ДЛЯ МУЖЧИН</p>
      <button class="forChildrenNike" id="forChildrenNike">
        <img src="nikePNG/childrenNike.png" class="photoChildrenNike" />
      </button>
      <p class="tForChildNike">ДЛЯ ДЕТЕЙ</p>
      <button class="forWomenNike" id="forWomenNike">
        <img src="nikePNG/nikeWomew.png" class="photoWomenNike" />
      </button>
      <p class="tForWomenNike">ДЛЯ ЖЕНЩИН</p>
    </div>
    <div class="second">
      <button class="odejdaNike">
        <img src="nikePNG/odejda.png" class="photoOdejdaNike" />
      </button>
      <p class="tOdejdaNike">Одежда</p>
      <button class="obivNike" id="obivNike">
        <img src="nikePNG/obivNikee.png" class="photoObivNike" />
      </button>
      <p class="tObivNike">Обувь</p>
      <button class="aksNike" id="aksNike">
        <img src="nikePNG/aksNikee.png" class="photoAksNike" />
      </button>
      <p class="tAksNike">Аксесуары</p>
    </div>
    <div class="niz"></div>
